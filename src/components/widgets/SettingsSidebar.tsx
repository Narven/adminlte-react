  ...
  return (
    <aside className='control-sidebar control-sidebar-dark'>
      <ul className='nav nav-tabs nav-justified control-sidebar-tabs'>
        <li className='active'><a href={'#'} data-toggle='tab'><i
          className='fa fa-wrench' /></a></li>
        <li><a href={'#'} data-toggle='tab'><i className='fa fa-home' /></a></li>
        <li><a href={'#'} data-toggle='tab'><i className='fa fa-gears' /></a></li>
      </ul>
